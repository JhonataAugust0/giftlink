...
# SQLAlchemy imports
from src.infrastructure.orm.config.db_config import engine

# routes
from src.adapters.input.api.v1.routes.group_route import groupRouter
from src.adapters.input.api.v1.routes.people_route import peopleRouter
from src.adapters.input.api.v1.routes.auth_routes import authRoutes
